...
lerMensagensNaoLidas() {
	...
	read -p "Digite 1 para visualizar mensagens encaminhadas para ORG1 ou 2 para ORG2: " Org
	...
	if [ "$Org" -eq 1 ]; then
        ...
        -c '{"function": "alterarStatusMensagem","Args":["ORG2"]}'
        ...
        --tlsRootCertFiles $PEER0_ORG1_CA \
        --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA   \
        -c '{"function": "alterarStatusMensagem","Args":["ORG1"]}'
